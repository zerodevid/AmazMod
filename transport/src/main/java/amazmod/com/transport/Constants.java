...
public class Constants {
    ...
    // How long Maps may stay quiet before the phone bothers to check whether it is still
    // navigating. Not a deadline: silence only prompts the question, it never answers it.
